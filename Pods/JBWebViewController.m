...
//  Pods
//
//  Created by SALEM on 14/02/2015.
//
//
...
- (void)setup {
    ...
    [_titleLabel setFont:[UIFont fontWithName:@"Avenir-Light" size:18.0]];
    [_titleLabel setTextAlignment:NSTextAlignmentNatural];
    [_titleLabel setText:@"Fevue"];
    [_titleLabel sizeToFit];
    
    _subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(2, 20, 0, 0)];
    [_subtitleLabel setBackgroundColor:[UIColor clearColor]];
    [_subtitleLabel setTextColor:[UIColor redColor]];
    [_subtitleLabel setFont:[UIFont fontWithName:@"DINAlternate-Bold" size:12]];
    [_subtitleLabel setTextAlignment:NSTextAlignmentLeft];
    [_subtitleLabel  setText:@"Fevue"];
