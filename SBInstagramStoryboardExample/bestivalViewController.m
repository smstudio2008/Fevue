...
@interface bestivalViewController()

@end

@implementation bestivalViewController
{
...
- (void)viewDidLoad
{
    ...
    if (SIMPLE_SAMPLE) {
        ...
        _glassScrollView1 = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"best-tic.jpg"]
  ...
  _flatRoundedButton = [[VBFPopFlatButton alloc]initWithFrame:CGRectMake(25, 30, 20, 20)
    ...
    _flatRoundedButton = [[VBFPopFlatButton alloc]initWithFrame:CGRectMake(35, 25, 40, 40)
                                                     buttonType:buttonBackType
                                                    buttonStyle:buttonRoundedStyle
                                          animateToInitialState:YES];
...
- (UIView *)customView
{
    ...
    _price.text = @"TICKETLINE                                      £136.75- £ 206.00 ";
    ...
    _price1.text =  @"STUBHUB                                        £239.00- £ 285.56 ";
...
-(void)festivalPrice {
    ...
    [controller showFromController:self];
       [Flurry logEvent:@"ticket- bestival - website-http://www.bestival.net"];
}



-(void)searchPrice1 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.ticketline.co.uk/bestival#tour"]];
    [controller showFromController:self];
     [Flurry logEvent:@"ticket- bestival - website-www.ticketline.co.uk"];
    
}

-(void)searchPrice2 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.stubhub.co.uk/bestival-tickets"]];
    [controller showFromController:self];
     [Flurry logEvent:@"ticket- bestival - website-www.stubhub.co.uk"];
