//
//  creamticViewController.m
//  fevue
//
//  Created by SALEM on 19/02/2015.
...
@interface creamticViewController()

@end

@implementation creamticViewController
{
...
- (void)viewDidLoad
{
    ...
    if (SIMPLE_SAMPLE) {
        ...
        _glassScrollView = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"background2"] blurredImage:nil viewDistanceFromBottom:120 foregroundView:view];
        ...
        _glassScrollView1 = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"cream-tic.jpg"]
    ...
    _flatRoundedButton = [[VBFPopFlatButton alloc]initWithFrame:CGRectMake(35, 15, 50, 40)
                                                     buttonType:buttonBackType
                                                    buttonStyle:buttonRoundedStyle
                                          animateToInitialState:YES];
...
- (UIView *)customView
{
    ...
    _bestivalLabel.text = @"CREAMFIELDS";
    ...
    _price.text = @"VIAGAGO.CO.UK                             £100.99- £ 223.99 ";
    ...
    _price1.text = @"SEATWAVES                                     £98.89- £ 395.00 ";
    ...
    _price2.text = @"TICKETMASTER                                £80.00- £ 180.00 ";
    ...
    _price3.text = @"STUBHUB                                        £126.26- £ 435.42 ";
...
-(void)festivalPrice {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"hhttp://www.creamfields.com/tickets"]];
    [controller showFromController:self];
    
          [Flurry logEvent:@"ticket- creamfield  - website-creamfield.co.uk"];
}

-(void)searchPrice1 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.viagogo.co.uk/Festival-Tickets/International-Festivals/Creamfields-Tickets"]];
    [controller showFromController:self];
              [Flurry logEvent:@"ticket- creamfield  - website-www.viagogo.co.uk"];
}

-(void)searchPrice2 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.seatwave.com/creamfields-tickets/season"]];
    [controller showFromController:self];
         [Flurry logEvent:@"ticket- creamfield  - website-www.seatwave.com"];
}

-(void)searchPrice3 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.ticketmaster.co.uk/creamfields2015"]];
    [controller showFromController:self];
      [Flurry logEvent:@"ticket- creamfield  - website-http://www.ticketmaster.co.uk"];
    
}

-(void)searchPrice4 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.stubhub.co.uk/creamfields-festival-tickets/"]];
    [controller showFromController:self];
    
         [Flurry logEvent:@"ticket- creamfield  - website-http://www.stubhub.co.uk"];
}
