...
- (void)viewDidLoad
{
    ...
    _titleHighlightColor = [UIColor colorWithRed:0.949 green:0.475 blue:0.208 alpha:1];
...
- (void)reloadData
{
    ...
    for (int i = 0; i < session; i ++) {
        ...
        for (int j = 0; j < [rowsOfSession[i] intValue]; j ++) {
            ...
            button.titleLabel.font = [UIFont fontWithName:@"DINAlternate-Bold" size:25];
            ...
            UIImageView *dot =[[UIImageView alloc] initWithFrame:CGRectMake(130,380,32,20)];
            dot.image=[UIImage imageNamed:@"downmenu.png"];
              [sessionView.containView addSubview:dot];
                             ...
                             complete:(void (^)(void))complete
{
    ...
    // _airImageView.image = [UIImage imageNamed:@"back.jpg"];
...
// MARK https://github.com/taphuochai/PHAirViewController/issues/13
