...
- (void)generateView {
    ...
    mainTextLabel.font = [UIFont fontWithName:@"GillSans-Light" size:25];
    ...
    mainTextLabel.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleWidth;
    ...
    subTextLabel.font = [UIFont fontWithName:@"DINCondensed-Bold" size:25];
    ...
    subTextLabel.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleWidth;
    ...
    if (_buttonText) {
        ...
        actionButton.titleLabel.font = [UIFont fontWithName:@"DINCondensed-Bold" size:25];
...
- (void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation {
    [self.movieView.layer.sublayers[0] setFrame:self.view.frame];
}
