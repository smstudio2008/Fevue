...
@interface isleticketViewController ()

@end

@implementation isleticketViewController
{
...
- (void)viewDidLoad
{
    ...
    if (SIMPLE_SAMPLE)
    {
     ...
     _glassScrollView1 = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"isle-tic.jpg"]
...
- (UIView *)customView
{
    ...
    _bestivalLabel.text = @"ISLE OF WIGHT ";
    ...
    _price.text = @"TICKETMASTER                              £145.00- £ 195.00 ";
    ...
    _price1.text = @"SEATWAVES                                   £244.95- £ 259.99 ";
    ...
    _price2.text = @"GETMEIN!                                       £154.00- £ 242.00 ";
    ...
    _price3.text = @"VIAGOGO.CO.UK                             £185.00- £ 299.00 ";
...
-(void)festivalPrice {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://isleofwightfestival.com/info/tickets.aspx"]];
    [controller showFromController:self];
           [Flurry logEvent:@"ticket- isleofwightfestival -website-isleofwightfestival.com"];
}

-(void)searchPrice1 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.ticketmaster.co.uk/IOW2015"]];
    [controller showFromController:self];
     [Flurry logEvent:@"ticket- isleofwightfestival -website-www.ticketmaster.co.uk"];
}

-(void)searchPrice2 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.seatwave.com/isle-of-wight-festival-tickets/season"]];
    [controller showFromController:self];
     [Flurry logEvent:@"ticket- isleofwightfestival -website-www.seatwave.com"];
    
}

-(void)searchPrice3 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.getmein.com/festivals/isle-of-wight-festival-tickets.html"]];
    [controller showFromController:self];
      [Flurry logEvent:@"ticket- isleofwightfestival -website-getmein.com"];
    
}

-(void)searchPrice4 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.viagogo.co.uk/Concert-Tickets/Alternative-and-Indie/Ash-Tickets/E-726762"]];
    [controller showFromController:self];
          [Flurry logEvent:@"ticket- isleofwightfestival -website-www.viagogo.co.uk"];
