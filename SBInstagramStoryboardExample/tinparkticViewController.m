...
@interface tinparkticViewController()

@end

@implementation tinparkticViewController
{
...
- (void)viewDidLoad
{
    ...
    if (SIMPLE_SAMPLE) {
        ...
        _glassScrollView1 = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"tinthepark-tic.jpg"]
...
- (UIView *)customView
{
    ...
    _bestivalLabel.text = @"T IN THE PARK ";
    ...
    _price.text = @"VIAGAGO.CO.UK                              £260.00- £ 284.09 ";
    ...
    _price1.text =  @"STUBHUB                                        £235.00- £ 295.00 ";
    ...
    _price2.text = @"GETME-IN                                       £192.50- £ 291.00 ";
...
-(void)festivalPrice {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.tinthepark.com/tickets.aspx"]];
    [controller showFromController:self];
 
     [Flurry logEvent:@"ticket- tinthepark-website-www.tinthepark.com"];
    
}

-(void)searchPrice1 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.viagogo.co.uk/Festival-Tickets/UK-Festivals/T-in-the-Park-Tickets"]];
    [controller showFromController:self];
        [Flurry logEvent:@"ticket- tinthepark-website-www.viagogo.co.uk"];
}

-(void)searchPrice2 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.seatwave.com/t-in-the-park-festival-tickets/season"]];
    [controller showFromController:self];
            [Flurry logEvent:@"ticket- tinthepark-website-www.seatwave.com"];
    
}

-(void)searchPrice3 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.getmein.com/festivals/t-in-the-park-festival-tickets.html"]];
    [controller showFromController:self];
        [Flurry logEvent:@"ticket- tinthepark-website-www.getmein.com"];
}
