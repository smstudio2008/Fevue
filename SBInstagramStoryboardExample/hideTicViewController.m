...
@interface  hideTicViewController()

@end

@implementation  hideTicViewController
{
...
- (void)viewDidLoad
{
    ...
    if (SIMPLE_SAMPLE) {
        ...
        _glassScrollView1 = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"hide-tic.jpg"]
...
-(void)festivalPrice {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.hideoutfestival.com/"]];
    [controller showFromController:self];
       [Flurry logEvent:@"ticket- hideout  - website-http://www.hideoutfestival.com/"];
