...
@interface glasticViewController()

@end

@implementation glasticViewController
{
...
- (void)viewDidLoad
{
    ...
    if (SIMPLE_SAMPLE) {
        ...
        _glassScrollView1 = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"glas-tic.jpg"]
...
- (UIView *)customView
{
    ...
    _bestivalLabel.text = @"GLASONBURY ";
    ...
    [button6 setTitle:@"CURRENTLY NOT AVAILABLE  " forState:UIControlStateNormal];
    button6.frame = CGRectMake(5, 45, 300, 150);
    button6.layer.borderWidth = 1.5;
    button6.layer.borderColor = [[UIColor whiteColor]CGColor];
   [box2  addSubview:button6];
...
-(void)festivalPrice {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.glastonburyfestivals.co.uk/information/tickets/"]];
    [controller showFromController:self];

     [Flurry logEvent:@"ticket- glastonbury-website-glastonburyfestivals.co.uk"];
}
