//
//  TOMTICViewController.m
//  fevue
//
//  Created by SALEM on 17/02/2015.
...
@interface TOMTICViewController()

@end

@implementation TOMTICViewController
{
...
- (void)viewDidLoad
{
    ...
    if (SIMPLE_SAMPLE) {
        ...
        _glassScrollView1 = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"tom-tic.jpg"]
...
- (UIView *)customView
{
    ...
    _bestivalLabel.text = @"TOMORROWLAND ";
    ...
    _price.text = @"VIAGOGO                                         £77.72- £ 535.22 ";
    ...
    _price1.text =  @"SEATWAVES                                 £534.87- £ 1466.67 ";
...
-(void)festivalPrice {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.tomorrowland.com/en/ticket-prices"]];
    [controller showFromController:self];
        [Flurry logEvent:@"ticket- tomorrowland - website-http://www.tomorrowland.com"];
}



-(void)searchPrice1 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.viagogo.co.uk/Festival-Tickets/Festivals-in-Belgium/Tomorrowland-Tickets"]];
    [controller showFromController:self];
      [Flurry logEvent:@"ticket- tomorrowland - website-http://www.viagogo.co.uk"];
}

-(void)searchPrice2 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.seatwave.com/tomorrowland-tickets/season"]];
    [controller showFromController:self];
       [Flurry logEvent:@"ticket- tomorrowland - website-www.seatwave.com"];
}
