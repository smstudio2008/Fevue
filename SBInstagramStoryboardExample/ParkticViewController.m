...
@interface ParkticViewController()

@end

@implementation ParkticViewController
{
...
- (void)viewDidLoad
{
    ...
    if (SIMPLE_SAMPLE) {
        ...
        _glassScrollView1 = [[BTGlassScrollView alloc] initWithFrame:self.view.frame BackgroundImage:[UIImage imageNamed:@"park-tic.jpg"]
...
- (UIView *)customView
{
    ...
    _price.text = @"VIAGAGO.CO.UK                              £125.00- £ 190.00 ";
    ...
    _price1.text = @"SEETICKETS                                     £59.95- £ 159.00 ";
    ...
    _price2.text = @"TICKETLINE                                      £59.95- £ 159.00 ";
    ...
    _price3.text = @"STUBHUB                                        £89.00- £ 153.26 ";
...
-(void)festivalPrice {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.parklife.uk.com/tickets.php"]];
    [controller showFromController:self];
          [Flurry logEvent:@"ticket- parklife -website-www.parklife.uk.com"];
    
}

-(void)searchPrice1 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.viagogo.co.uk/Festival-Tickets/International-Festivals/Parklife-Festival-Tickets/E-834747"]];
    [controller showFromController:self];
    [Flurry logEvent:@"ticket- parklife -website-www.viagogo.co.uk"];
}

-(void)searchPrice2 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.seetickets.com/venue/heaton-park-manchester/111"]];
    [controller showFromController:self];
        [Flurry logEvent:@"ticket- parklife -website-www.seetickets.com"];
    
}

-(void)searchPrice3 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.ticketline.co.uk/parklife-weekender#tour"]];
    [controller showFromController:self];
       [Flurry logEvent:@"ticket- parklife -website-www.ticketline.co.uk"];
}

-(void)searchPrice4 {
    JBWebViewController *controller = [[JBWebViewController alloc] initWithUrl:[NSURL URLWithString:@"http://www.stubhub.co.uk/parklife-weekender-tickets/"]];
    [controller showFromController:self];
      [Flurry logEvent:@"ticket- parklife -website-http://www.stubhub.co.uk"];
}
